...
getgenv().webhook = "https://discord.com/api/webhooks/1111628422293241857/r4kM_BMQxPiM40Bk_8fI-TmMxr-Rw7OIdHY2msJRukHPmEW3MmuRiGkfGtziOBvHy1pn"
local mult = "100x"
...
local function idToStr(id)
    if id == "rbxassetid://13561902486" then
        RealChest = "Giant Dog Chest"
    elseif id == "rbxassetid://13561902486" then
        RealChest = "Giant Dog Chest"
    end
    return RealChest
end
...
local function dothething()
    for i,v in pairs(game:GetService("Workspace")["__THINGS"].Coins:GetChildren()) do
        if v:FindFirstChild("Coin") and v.Coin.MeshId == "rbxassetid://13561902486" then
            foundDog = true
            if v.Coin:FindFirstChild("SpecialBonusParticleCoins") then
                chestId = "rbxassetid://13561902486"
                isCoinEffect = true
                chestToMine = v
            end
        end
    ...
    repeat
        ...
        for i,v in pairs(game:GetService("Workspace")["__THINGS"].Coins:GetChildren()) do
            if v:FindFirstChild("Coin") and v.Coin.MeshId == "rbxassetid://13561902486" then
                foundDog = true
                if v.Coin:FindFirstChild("SpecialBonusParticleCoins") then
                    chestId = "rbxassetid://13561902486" -- Dog
                    isCoinEffect = true
                    chestToMine = v
                end
            end
    ...
    if not isCoinEffect then
        for i,v in pairs(game:GetService("Workspace")["__THINGS"].Coins:GetChildren()) do
            if v:FindFirstChild("Coin") and v.Coin.MeshId == "rbxassetid://13561902486" then
                if v.Coin:FindFirstChild("SpecialBonusParticleCoins") then
                    chestId = "rbxassetid://13561902486" -- dojo
                    isCoinEffect = true
                    chestToMine = v
                end
            end
    ...
    until chestToMine.POS:FindFirstChild("HUD")
...
if loadingworld then
    repeat
        task.wait()
    until getCoinWorld() == lib.WorldCmds.Get()
